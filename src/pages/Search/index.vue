        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active:ArrOrder[0]==='1'}"
                    @click="setOrder('1')"
                >
                  <a href="javascript:">综合
                    <i class="iconfont"
                       :class="(ArrOrder[1] === 'desc') ? 'icon-arrow-down':'icon-arrow-up'"
                       v-if="ArrOrder[0]==='1'"
                    ></i>
                ...
                <li>
                  <a href="javascript:" style="pointer-events:none;">销量</a>
                </li>
                <li>
                  <a href="javascript:" style="pointer-events:none;">新品</a>
                </li>
                <li>
                  <a href="#" style="pointer-events:none;">评价</a>
                </li>
                <li :class="{active:ArrOrder[0]==='2'}">
...
<!--                    <a href="item.html" target="_blank"><img :src="item.defaultImg"/></a>-->
         ...
         <MyPagination
          ...
          :itemTotal="productList.total"
          :quantityPerPage="options.pageSize"
          :consecutivePageNumbers="5"
...
export default {
  ...
  mounted() {
    this.getShopList()
    //console.dir(this.options.order);
  },

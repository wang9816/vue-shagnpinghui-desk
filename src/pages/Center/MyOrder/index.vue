  ...
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="orders" >
        ...
        <table class="order-item" v-for="item in myOrderList" :key="item.id">
          <thead>
          <tr>
            <th colspan="5">
          ...
          <tr v-for="(item2,index) in item.orderDetailList" :key="item2.id">
            <td width="60%" >
              <div class="typographic"  >
                <img :src="item2.imgUrl" style="width: 60px;height: 60px;">
                <a href="#" class="block-text">包邮 {{item2.skuName}}</a>

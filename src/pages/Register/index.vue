  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <button style="width: 100px;height: 38px;" @click="getVCode">获取验证码</button>
      ...
      <div class="content">
        ...
        <input type="text" placeholder="请输入你的登录密码" v-model="password" name="password" v-validate="{required: true,regex: /^\d{6,20}$/}"
               :class="{invalid: errors.has('password')}">
        <span class="error-msg">{{ errors.first('password') }}</span>
      </div>
      <div class="content">
        <label>确认密码:</label>
        <input type="text" placeholder="请再次输入你的登录密码" v-model="password2" name="password2" v-validate="{required: true,is:(password)}"

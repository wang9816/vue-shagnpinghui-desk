          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(item,index) in spuSaleAttrList" :key="item.id">
                ...
                <dd changepirce="0" :class="{active:item2.isChecked==='1'}"
                    v-for="(item2,index) in item.spuSaleAttrValueList"
                    :key="item2.id"
                    @click="changeChecked(item2,item.spuSaleAttrValueList,index)"
    ...
    methods:{
      async addShoppingCart(){
        ...
        try {
          ...
          await sessionStorage.setItem('SKUINFO_KEY',JSON.stringify(this.skuInfo))
      ...
      /*button color*/
      changeChecked(item2,SpuSaleAttrValueList,index){
    ...
    watch:{
      $route:{
        ...
        handler(){
          ...
          this.$store.dispatch('getSkuDetailInfo',skuId)

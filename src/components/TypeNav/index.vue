                    ...
                    >
                      ...
                      <dd>
                        ...
                        >
                          ...
                          >{{ c3.categoryName }}</a>
                          <!--
                                                <a href="javascript:" @click="$router.push(`/Search?$categoryName=${c3.categoryName}&&categoryId=${c3.categoryId}`)">{{ c3.categoryName }}</a>
                          -->
...
export default {
  ...
  methods: {
    //mouse leave and hide the nav
    //state:mouse in:-2>index mouse out index>-1
    hideFirst() {
      this.currentIndex = -2
      if (this.$route.path !== '/') {
